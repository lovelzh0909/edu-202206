...
import com.example.demo.TestManage.entity.Studenttestflag;
import com.example.demo.TestManage.service.StudenttestflagService;
...
public class StudenttestflagController {
    private final StudenttestflagService studenttestflagService;

    @Autowired
    public StudenttestflagController(StudenttestflagService studenttestflagService) {
        this.studenttestflagService = studenttestflagService;
    }
