...
public class PaperJustifyController {
    ...
    @Autowired
    PaperJustifyController(PaperJustifyService paperJustifyService,QuestionService questionService,TestrelstudentService testrelstudentService,QuestionrelscoreService questionrelscoreService,TestService testService){
