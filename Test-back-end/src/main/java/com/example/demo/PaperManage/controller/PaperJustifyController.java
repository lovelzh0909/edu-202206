package com.example.demo.PaperManage.controller;
...
import com.example.demo.PaperManage.entity.PaperJustify;
import com.example.demo.PaperManage.service.PaperJustifyService;
...
public class PaperJustifyController {
    ...
    @Autowired
    public PaperJustifyController(PaperJustifyService paperJustifyServiceQuestionService, QuestionService questionService, TestrelstudentService
            testrelstudentService, QuestionrelscoreService questionrelscoreService, TestService testService) {
        this.paperJustifyService = paperJustifyServiceQuestionService;
